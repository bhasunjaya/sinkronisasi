...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        {!! Form::open(['url'=>'djpk/subbidang/'.$subbidang->id,'method'=>'PUT']) !!}

        <div class="form-group form-group-default required ">
            <label>Bidang</label>
            {!! Form::select('bidang_id',\App\Bidang::pluck('nama','id'),old('bidang_id',$subbidang->id),['class'=>'form-control']) !!}
        </div>
        <div class="form-group form-group-default required ">
            <label>nama</label>
            {!!  Form::text('nama',old('nama',$subbidang->nama),['class'=>'form-control']) !!}
        </div>
