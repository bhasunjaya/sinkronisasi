...
var hot = new Handsontable(container, {
    ...
    columns: [
        { data: 'jenis', width: 220,editor: false},
        { data: 'kegiatan.subbidang.bidang.nama', width: 140,editor: false },
        { data: 'kegiatan.subbidang.nama', width: 140 ,editor: false},
        { data: 'kegiatan.kegiatan', width: 220 ,editor: false},
        { data: 'output', width: 120 ,editor: false},
        { data: 'dana', width: 120 ,editor: false},
